      ...
      {...{
        ...
        propList: [
          ...
          },
          {
            ...
            type: 'string',
            description:
              'Class to put on the inner `div` containing the custom arrow icon'
          },
          {
            name: 'children',
            type: 'node',
          ...
          },
          {
            ...
            type: 'function',
            description:
              'Callback called with the new selected value whenever selection changes'
          },
          {
            name: '...props',
            description:
              'All other props will be passed to the `select` element'
          }
        ],
        examples: (
          <div>
            ...
            <Example
              {...{ title: 'Select with optgroups and disabled options' }}>
              <Select>
                <option value="">Choose one...</option>
